...
<input type="button" name="dia_practicas" value="lunes">Lunes
<input type="button" name="dia_practicas" value="martes">Martes
<input type="button" name="dia_practicas" value="miercoles">Miércoles
<input type="button" name="dia_practicas" value="jueves">Jueves
<input type="button" name="dia_practicas" value="viernes">Viernes
<input type="button" name="dia_practicas" value="sabado">Sábado
