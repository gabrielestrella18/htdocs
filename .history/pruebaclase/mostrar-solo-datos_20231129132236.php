...
<body>
    ...
    <p class="alinear"><a id="mostrar" href="index.php">&lt;&lt; REGRESAR</a></p>

    <div class="contenedor">
        <?php
        include "conexion.php";
        $todos_usuarios = "SELECT * FROM datos ORDER BY columna ASC";
        $resultado = mysqli_query($conexion, $todos_usuarios);

        while ($registro = mysqli_fetch_assoc($resultado)) {
        ?>
            <div class="cajas">
                <a href="<?php echo $registro['ruta'] ?>" target="_blank">
