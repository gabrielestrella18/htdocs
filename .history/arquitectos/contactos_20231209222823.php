  ...
  <div class="cont_form anchito">
    ...
    <div class="form">
        <form  class="centro" action="contactos.php" method="post">
          ...
          <input type="text" name="Nombre" class="campos" required><br><br><br>
          ...
          <select name="Servicio" id="" class="campos" required>
          ...
          <button type="submit" id="guardar" class="boton4">Guardar Contacto</button>
